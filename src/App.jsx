    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <p className="font-lexend mb-7">Escolha um sedan pelo seu preço acessível e Zexcelente economia de combustível. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
          <a href="https://www.webmotors.com.br/sedans?idcmp=s08%3Ac13%3A3ea9720bc8b644d8a93f04b278d48332&gclsrc=aw.ds&gad_source=1&gclid=Cj0KCQjwk6SwBhDPARIsAJ59Gwf13fIvwM3nKcmKTJpzkqHcvGRCHlXP249zOXIHYLYi5x6O-DvsP1saAkTsEALw_wcB" target="_blank" className="font-lexend">Ver mais</a>
        </div>
        ...
        <div className="bg-green p-12">
          ...
          <a href="https://www.webmotors.com.br/suvs?idcmp=s08%3Ac13%3Acc5557bdc18f4ebb8d2de994389066c7&gclsrc=aw.ds&gad_source=1&gclid=Cj0KCQjwk6SwBhDPARIsAJ59GweBS9OxZmirDahwTdFyQhAq0SRNoG5erDFikLcdUdR_FMNRWjj8ymYaAiusEALw_wcB" target="_blank" className="font-lexend">Ver mais</a>
        </div>
